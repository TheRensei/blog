...
I'm using [alchemy](https://app.alchemyrpg.com/) as my main VTT for games with my group. And since I like to mess with stuff here is some of the things I made. Thankfully since it's just a webapp it's quite easy to mess around with it using js. 
